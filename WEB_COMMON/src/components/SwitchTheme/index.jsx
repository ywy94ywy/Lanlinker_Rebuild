...
import { Icon, Dropdown, Radio } from 'antd'
...
const Content = () => {
  ...
  return (
    <div className={style.wrapper}>
      <div className={style.title}>字体大小</div>
      <Radio.Group
        className={style.fontList}
          ...
          <Fragment key={index}>
            ...
            <div className={style.bgList}>
              {item.value.map((v, i) => (
                ...
                >
                  {bg === v && (
                    <Icon type='check' className={style.icon}></Icon>
                  )}
                </div>
              ))}
            </div>
