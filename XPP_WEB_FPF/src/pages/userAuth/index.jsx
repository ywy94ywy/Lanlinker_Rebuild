  ...
  return (
    <PageHeaderWrapper>
      <div className={style.userAuth}>
        <CustomCard icon="icon-shortcut" title="个人实名信息管理" className={style.infoCard}>
        ...
        <CustomCard icon="icon-shortcut" title="用户实名认证情况列表" gap>
          <Table columns={columns} dataSource={dataSource}></Table>
        </CustomCard>
        <CustomCard icon="icon-shortcut" title="企业信息管理" gap>
